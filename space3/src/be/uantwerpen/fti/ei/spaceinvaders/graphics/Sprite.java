...
public class Sprite {
    ...
    public static void draw(Graphics2D g, ArrayList<BufferedImage> img,int width, int height,int xOffset,int yOffset){

        //g.drawImage(img.get(i),(int) xOffset,(int) yOffset, width, height,null);
    ...
    public static void drawArray(Graphics2D g,BufferedImage img,int width, int height,int xOffset,int yOffset){
